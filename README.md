...
<p align="center">
  <a href="https://github.com/cloudboy-jh/glib-code/releases/latest">
    <img src="https://img.shields.io/badge/version-0.1.4-1e293b?style=flat-square" alt="Latest release" />
  </a>
...
| Platform | File |
|----------|------|
| Windows | `glib-code-Setup-0.1.4.exe` |
| Mac | `glib-code-0.1.4-arm64.dmg` |
| Linux | `glib-code-0.1.4.AppImage` |
